...
class Bus5TrackingScreen extends StatelessWidget {
  @override
      ...
      appBar: AppBar(
        title: Row(
          children: [ 
            CircleAvatar(
              radius: 20,
              backgroundImage: AssetImage('assets/images/five.png'), // Replace with actual bus avatar image
            ),
            SizedBox(width: 10),
            Text('Bus 5'),
          ],
        ...
        children: [
          ...
          Positioned(
           ...
           child: Column(
              ...
              children: [
                StopWidget(name: 'Mavelikara', isSource: true, isDestination: false),
                SizedBox(height: 60), // Adjust this value as needed
                StopWidget(name: ' Haripad', isSource: false, isDestination: false),
                SizedBox(height: 60), // Adjust this value as needed
